...
export default function Header() {
  return (
    <header className="bg-gray-900 text-white px-6 py-2 shadow">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between w-full gap-2">
        ...
        <nav className="flex text-sm md:text-base justify-center gap-x-6 flex-1">
          <Link to="/home" className="hover:text-yellow-400 transition">Accueil</Link>
          ...
          <Link to="/messages" className="hover:text-yellow-400 transition">Messages</Link>
        </nav>
