...
export default function SerieDetails() {
    ...
    const url = `https://api.themoviedb.org/3/tv/${id}?api_key=${API_KEY}&language=fr-FR`;
    ...
    return (
        <div className="p-4 max-w-2xl mx-auto">
            ...
            {data.poster_path ? (
                <img src={`https://image.tmdb.org/t/p/w300${data.poster_path}`} alt={data.name} className="mb-4 rounded" />
            ) : (
            ...
            <div className="text-white mb-2"><strong>Date de première diffusion :</strong> {data.first_air_date}</div>
